...
import numpy as np
from src.encoders.vision_transformer import VisionTransformer, Block
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, vit: VisionTransformer,
        ...
        embed_dim = vit.cls_token.shape[-1]
    ...
    def initialize_weights(self):
        ...
        # We overwrite the ViT's pos_embed with sin-cos for MAE training
        ...
        decoder_pos_embed = get_2d_sincos_pos_embed(self.decoder_pos_embed.shape[-1], int(self.vit.patch_embed.num_patches**.5), cls_token=True)
        ...
        torch.nn.init.normal_(self.vit.cls_token, std=.02)
...
# --------------------------------------------------------
# 2D Sine-Cosine Position Embedding Helper functions
# --------------------------------------------------------
